...
const Update = () => {
  ...
  const handleDeletePlat = (event) => {
    const filteredPlat = input.platforms.filter(
      (plat) => plat !== event.target.value
    );
    setInput({
      ...input,
        ...
        >
          ...
          <div className={style.platGen}>
            <div className={style.plat}>
              ...
              <p
                className={style.errores}
                style={{ visibility: errors.platforms ? "visible" : "hidden" }}
              >
                {errors.platforms}
              </p>
            </div>
            ...
            <div className={style.gen}>
              ...
              <p
                className={style.errores}
                style={{ visibility: errors.genres ? "visible" : "hidden" }}
              >
                {errors.genres}
              </p>
            </div>
      ...
      <div className={style.previewCont}>
        ...
        <div className={style.previewPlat}>
          {input.platforms.map((plat) => {
            return (
              <div className={style.platforms} key={plat}>
                {" "}
                {plat}
                <button
                  className={style.btnDelete}
                  value={plat}
                  onClick={(e) => handleDeletePlat(e)}
                >
                  x
                </button>
              </div>
        ...
        <div className={style.previewGenres}>
          {input.genres.map((gen) => {
            return (
              <div key={gen} className={style.genres}>
                {" "}
                {gen}
                <button
                  className={style.btnDelete}
                  value={gen}
                  onClick={(e) => handleDeleteGen(e)}
                >
                  x
                </button>
              </div>
