    ...
    <>
      <div className={style.filtrosCont}>
        ...
        <div className={style.buttonDiv}>
          <button
            ...
            title="api"
          >
            <img className={style.imgs} src={api} alt="api" />
          </button>
          <button
            className={style.btnFilters}
            ...
            title="created"
          >
            <img className={style.imgs} src={created} alt="created" />
          </button>
        </div>
      </div>
      ...
      <div className={style.filtrosCont}>
        ...
        <div className={style.buttonDiv}>
          <button
            className={style.btnFilters}
            onClick={() => handleFilter("inc")}
            title="increase"
          >
            <img className={style.imgs} src={ascRating} alt="increase" />
          </button>
          <button
            className={style.btnFilters}
            onClick={() => handleFilter("dec")}
            title="decrease"
          >
            <img className={style.imgs} src={desRating} alt="decrease" />
          </button>
        </div>
      </div>
      ...
      <div className={style.filtrosCont}>
        ...
        <div className={style.buttonDiv}>
          <button
            className={style.btnFilters}
            onClick={() => handleFilter("inc_aZ")}
            title="a-z"
          >
            <img className={style.imgs} src={aZ} alt="increase" />
          </button>
          <button
            className={style.btnFilters}
            onClick={() => handleFilter("dec_zA")}
            title="z-a"
          >
            <img className={style.imgs} src={zA} alt="decrease" />
          </button>
        </div>
      </div>
      ...
      <div className={style.title_btn}>
        ...
        <div className={style.buttonDiv}>
          <button className={style.applyBtn} onClick={handleFilterApply}>
            apply
          </button>
        </div>
      </div>
          ...
          return (
            <>
              <button
                ...
                onClick={() => handleDeletedFilter(x.value)}
              >
                {x.value}
              </button>
            </>
